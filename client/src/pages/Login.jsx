...
const Login = () => {
  ...
  return (
    <div style={{
      ...
      background: 'radial-gradient(circle at top right, #1a1a2e, #0A0A0A 60%)',
      padding: '20px'
    }}>
      <div className="glass-panel animate-fade-in" style={{
        ...
        {/* Decorative elements */}
        <div style={{ position: 'absolute', top: '-50px', right: '-50px', width: '100px', height: '100px', background: 'var(--accent-blue)', filter: 'blur(60px)', opacity: 0.5 }}></div>
        <div style={{ position: 'absolute', bottom: '-50px', left: '-50px', width: '100px', height: '100px', background: 'var(--accent-purple)', filter: 'blur(60px)', opacity: 0.5 }}></div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group" style={{ marginBottom: '32px' }}>
            <div className="flex-between">
              ...
              <Link to="/forgot" style={{ fontSize: '0.8rem' }}>Forgot?</Link>
            </div>
